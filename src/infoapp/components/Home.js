...
export default function Home() {
    ...
    return (
        <>
            <header style={{background: "radial-gradient(black, transparent)"}} className="bg-dark">
                    ...
                    <div className="row pt-5">
                        ...
                        <div className="col-12 col-lg-10 mx-auto">
                            <div className="position-relative" style={{ display: "flex", flexWrap: "wrap", justifyContent: "flex-end" }}>
                                <div style={{ position: "relative", flex: "0 0 45%", transform: "translate3d(-15%, 35%, 0)" }}><img className="img-fluid" alt="place" data-bss-parallax="" data-bss-parallax-speed="0.8" src="/assets/img/banner1.jpg" /></div>
                                <div style={{ position: "relative", flex: "0 0 45%", transform: "translate3d(-5%, 20%, 0)" }}><img className="img-fluid" alt="place" data-bss-parallax="" data-bss-parallax-speed="0.4" src="/assets/img/banner2.jpg" /></div>
                                <div style={{ position: "relative", flex: "0 0 45%", transform: "translate3d(0, 0%, 0)" }}><img className="img-fluid" alt="place" data-bss-parallax="" data-bss-parallax-speed="0.25" src="/assets/img/banner0.jpg" /></div>
                            </div>
                        </div>
                    </div>
                </div>
            </header>
            <section style={{background: "radial-gradient(black, transparent)"}} className="bg-dark radient">
            ...
            <Contact />
            <section style={{background: "radial-gradient(black, transparent)"}} className="py-4 bg-dark">
