...
export default function Home() {
  return (
    <>
      <header
        style={{ background: "radial-gradient(#1c1d21, transparent)" }}
        className="bg-dark tina"
      >
        <div className="container pt-4 pt-xl-5 mina sona relative">
              ...
              >
                ...
                >
                  <img
                    ...
                    src="/assets/img/banner0.jpg"
                  />
                </div>
              </div>
            </div>
          </div> */}
          <div className="text-center d zind">
            <p className=" text-success ">Collaborate, Learn, Cure</p>
            <h1 className="">Uniting Medical Minds for Better Health</h1>
          </div>
          <div className="imgH">
            <img
              className=""
          ...
          <a href="#service-container" id="scroll-down-animation">
            ...
            <h2 className="t2">Scroll down</h2>
          </a>
        </div>
      </header>
      <section
                ...
                <div className="card shadow-sm">
                  <div className="card-body px-4 py-5 px-md-5">
                    ...
                    <p className="text-muted card-text mb-4">
                      DocSphere allows doctors to create a profile, connect with
              ...
              <div className="col mb-5">
                <div className="card shadow-sm">
                  <div className="card-body px-4 py-5 px-md-5">
                    ...
                    <p className="text-muted card-text mb-4">
                      We provides the latest updates and insights on healthcare
                      topics from around the world. Our goal is to keep our
                      readers informed and up-to-date on the most pressing
              ...
              <div className="col mb-4">
                <div className="card shadow-sm">
                  <div className="card-body px-4 py-5 px-md-5">
                    ...
                    <p className="text-muted card-text mb-4">
                      The Disease mapping provides an interactive platform for
                      users to explore the prevalence and distribution of
                      various diseases around the world.{" "}
                    </p>
                    <button className="btn btn-primary shadow" type="button">
                      Learn more
                    </button>
              ...
              <div className="col mb-4">
                <div className="card shadow-sm">
                  <div className="card-body px-4 py-5 px-md-5">
                    ...
                    <p className="text-muted card-text mb-4">
                      We welcome submissions from healthcare professionals,
                      researchers, patients, and anyone with a passion for
