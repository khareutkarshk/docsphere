...
export default function Services() {
  return (
    <>
      <section
        style={{ background: "radial-gradient(#26262b, transparent)" }}
        className="bg-dark tina py-5"
      >
            ...
            <div className="col d-md-flex align-items-md-end align-items-lg-center mb-5">
              <div>
                ...
                <p className="text-muted mb-4">
                  The Disease mapping provides an interactive platform for users
                  to explore the prevalence and distribution of various diseases
                  around the world.{" "}
                </p>
            ...
            <div className="col d-md-flex align-items-md-end align-items-lg-center mb-5">
              <div>
                ...
                <p className="text-muted mb-4">
                  ...
                  researchers, patients, and anyone with a passion for advancing
            ...
            <div className="col d-md-flex align-items-md-end align-items-lg-center mb-5">
              <div>
                ...
                <p className="text-muted mb-4">
                  ...
                  topics from around the world. Our goal is to keep our readers
                  informed and up-to-date on the most pressing issues in
                  healthcare.
                </p>
                <Link to="/login" className="btn btn-primary shadow">
                  Learn more
