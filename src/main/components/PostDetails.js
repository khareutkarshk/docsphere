                ...
                {post && (
                    <a href={`/post/${post.id}`} style={{ textDecoration: "none", backgroundColor: "#252525", maxWidth: "80%" }} className="post-card border-0 p-3 m-3 container card">
                        <div className="d-flex gap-3">
                            <div className=" post-profile-icon"><img alt="profile" className="border rounded-circle img-profile" style={{ height: "50px", width: "50px" }} src={`https://storage.googleapis.com/money-flow-410110/${post.profile}`} /></div>
